      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        >
          ...
          <div class="space-y-4">
            ...
            <!-- CTA Button -->
            <div class="pt-4">
              <button class="bg-gradient-to-r from-nexos-orange to-nexos-blue hover:from-nexos-orange/90 hover:to-nexos-blue/90 text-white font-semibold py-3 px-6 rounded-full transition-all duration-300 transform hover:scale-105 shadow-adaptive text-sm">
                Conocer más
              </button>
            </div>
          </div>
