...
const contactInfo = [
  {
    icon: '📧',
    title: 'Email',
    value: 'hola@nexos.dev',
    link: 'mailto:hola@nexos.dev'
  },
  {
    icon: '📱',
    title: 'WhatsApp',
        ...
        <div class="space-y-8">
          ...
          <div class="bg-theme-overlay-light backdrop-blur-adaptive rounded-2xl p-8 border border-theme-light shadow-adaptive">
            ...
            <div class="flex space-x-4">
              <a href="#" class="bg-nexos-orange/20 hover:bg-nexos-orange/30 p-3 rounded-lg transition-all duration-300 transform hover:scale-105">
                <svg class="w-6 h-6 text-nexos-orange" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M24 4.557c-.883.392-1.832.656-2.828.775 1.017-.609 1.798-1.574 2.165-2.724-.951.564-2.005.974-3.127 1.195-.897-.957-2.178-1.555-3.594-1.555-3.179 0-5.515 2.966-4.797 6.045-4.091-.205-7.719-2.165-10.148-5.144-1.29 2.213-.669 5.108 1.523 6.574-.806-.026-1.566-.247-2.229-.616-.054 2.281 1.581 4.415 3.949 4.89-.693.188-1.452.232-2.224.084.626 1.956 2.444 3.379 4.6 3.419-2.07 1.623-4.678 2.348-7.29 2.04 2.179 1.397 4.768 2.212 7.548 2.212 9.142 0 14.307-7.721 13.995-14.646.962-.695 1.797-1.562 2.457-2.549z"/>
                </svg>
              </a>
              <a href="#" class="bg-nexos-blue/20 hover:bg-nexos-blue/30 p-3 rounded-lg transition-all duration-300 transform hover:scale-105">
              ...
              <a href="#" class="bg-pink-500/20 hover:bg-pink-500/30 p-3 rounded-lg transition-all duration-300 transform hover:scale-105">
              ...
              <a href="#" class="bg-blue-600/20 hover:bg-blue-600/30 p-3 rounded-lg transition-all duration-300 transform hover:scale-105">
