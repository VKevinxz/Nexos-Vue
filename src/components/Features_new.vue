  ...
  <section ref="featuresRef" id="features" class="py-20 px-4 relative">
    ...
    <div class="max-w-7xl mx-auto relative z-10">
      ...
      <div class="text-center mb-16 scroll-animate fade-down">
        ...
        <p class="text-xl text-gray-300 max-w-3xl mx-auto scroll-animate fade-up stagger-1">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div 
          ...
          :key="feature.title"
          class="bg-white/5 backdrop-blur-md rounded-2xl p-8 border border-white/10 hover:border-white/20 transition-all duration-300 hover:transform hover:scale-105 scroll-animate"
        ...
        >
          ...
          <div class="space-y-4">
            ...
            <!-- Services list -->
            <div class="space-y-2">
              <h4 class="text-white font-semibold mb-3">Servicios incluidos:</h4>
              <ul class="space-y-2">
